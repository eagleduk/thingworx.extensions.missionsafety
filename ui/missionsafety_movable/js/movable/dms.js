 ...
 */
class Dms { // note prototypal class not classical class
    ...
    static toLat(deg, format, dp) {
        ...
        return lat===null ? '–' : lat.slice(1) + DmsSeparator + (deg<0 ? 'S' : 'N');  // knock off initial '0' for lat!
    }
    ...
    static toLon(deg, format, dp) {
        ...
        return lon===null ? '–' : lon + DmsSeparator + (deg<0 ? 'W' : 'E');
    }
